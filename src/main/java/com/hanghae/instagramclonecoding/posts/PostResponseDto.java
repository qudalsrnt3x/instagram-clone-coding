...
public class PostResponseDto {
    ...
    public PostResponseDto(Long id, Long uid, String nickname, String content, String imageUrl , Long commentCount, Long likeCount,
                           List<CommentUserDto> commentUserDto, List<LikeUserDto> likeUserDto, Dto dto, String user_profile, LocalDateTime createdAt, LocalDateTime modifiedAt
) {
        this.id = id;
        this.uid = uid;
